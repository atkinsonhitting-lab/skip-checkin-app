...
const SEED_ENTRIES = [
  ...
  { type: 'rule', title: 'Never invent a cause',
    body: 'If a hitter describes a problem — rolling over, popping up, feeling late, pulling off, weak grounders — never state or imply a specific mechanical cause as THE reason (wrapping the bat, casting, flying open, dropping the hands, out in front, losing the plane) unless the hitter described that cause himself or you have seen video of his swing. Translating his symptom into mechanics ("weak grounders means you\'re out in front") IS the diagnosis — stay in his words. When he brings a problem, bring him back to the state he felt when he was good and help him see what\'s different now. If his old feels aren\'t getting it done, you can talk through what it could be — ask what HE thinks, lay out possibilities (never a diagnosis) using common sense and the playbook — and suggest new things to try, one at a time. A guessed cause teaches the wrong fix.',
